<template>
    ...
    <div class="mt-3 flex items-center">
        ...
        <div
            ...
            class="ml-auto text-orange-400 cursor-pointer hover:text-cta-orange text-sm underline"
        >
            Reset
        </div>
    </div>
...
export default {
    ...
    data() {
        return {
            sliderClasses: {
                ...
                handle: 'absolute rounded-full bg-white border-red-500 border shadow-slider cursor-grab focus:outline-none h:w-4 h:h-4 h:-top-1.5 h:-right-2 txt-rtl-h:-left-2 txt-rtl-h:right-auto v:w-4 v:h-4 v:-top-2 v:-right-1.25 disabled:cursor-not-allowed focus:ring focus:ring-red-500 focus:ring-opacity-30',
    ...
    mounted() {
        this.original = JSON.parse(JSON.stringify(this.modelValue))
    }
}
</script>
